...
# Automatic difficulty management (no configuration required):
# - Proxy sends (pool_difficulty + 1000) to miner to prevent vardiff duplicates
...
# - On low-difficulty rejection: raises to (rejected_diff + 1000) if higher
# - On stale share rejection: lowers by 1000 (if still above pool difficulty)
"""
